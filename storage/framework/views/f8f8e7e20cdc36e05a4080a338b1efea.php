<?php $__env->startSection('title', $site['name'] . ' • Beranda'); ?>
    ...
    <section class="grid gap-8 lg:grid-cols-[1.3fr_0.7fr] lg:items-center">
        <div class="space-y-6">
            <div class="inline-flex items-center gap-2 rounded-full border border-emerald-500/20 bg-emerald-500/10 px-4 py-2 text-sm text-emerald-200">
                <span>●</span> <?php echo e($site['tagline']); ?>
            ...
            <div class="flex flex-wrap gap-3">
                <a href="<?php echo e(route('login')); ?>" class="rounded-2xl bg-emerald-500 px-5 py-3 font-semibold text-slate-950 transition hover:bg-emerald-400">
                    Masuk ke Dashboard
                </a>
                ...
                <article class="rounded-[2rem] border border-white/10 bg-slate-900/70 p-6 ring-1 ring-white/5">
                    <div class="flex items-start justify-between gap-4">
                        <div>
                            ...
                            <h3 class="mt-4 text-2xl font-bold text-white"><?php echo e($plant['name']); ?></h3>
                        </div>
                        <span class="rounded-2xl border border-white/10 bg-white/5 px-3 py-2 text-xs text-slate-300">pH <?php echo e($plant['ideal_ph_min']); ?>–<?php echo e($plant['ideal_ph_max']); ?></span>
                    </div>
                    ...
                    <div class="mt-5 space-y-3">
                        <div>
                            ...
                            <ul class="mt-2 space-y-2 text-sm text-slate-300">
                                <?php $__currentLoopData = $plant['advantages']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $advantage): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <li class="flex gap-2"><span class="text-emerald-400">•</span><span><?php echo e($advantage); ?></span></li>
                        ...
                        <div>
                            ...
                            <p class="mt-2 text-sm leading-7 text-slate-300"><?php echo e($plant['ideal_environment']); ?></p>
                        </div>
                    </div>
                </article>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laragon\www\smart_sabin\resources\views/welcome.blade.php ENDPATH**/ ?>